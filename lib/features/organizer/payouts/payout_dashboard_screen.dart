...
class _PayoutDashboardScreenState
    extends ConsumerState<PayoutDashboardScreen> {
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _summaryRow('Gross Revenue',
                CurrencyHelper.format(event.grossRevenue.toDouble(), AppCurrency.usd)),
            _summaryRow(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Event>>(
        future:
            ref.read(eventRepositoryProvider).getEventsByOrganizer(user.id),
